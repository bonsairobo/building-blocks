...
pub use point::{
    Bounded, Distance, DotProduct, IntegerPoint, MapComponents, Norm, NormSquared, Ones, Point,
    PointN, SmallZero,
};
...
pub mod prelude {
    pub use super::{
        ...
        Extent3i, ExtentN, IntegerExtent, IntegerPoint, MapComponents, Norm, NormSquared, Ones,
        Point, Point2, Point2f, Point2i, Point3, Point3f, Point3i, PointN, SmallZero,
    };
}
