...
impl MinMaxComponent for Point3i {
    type Scalar = i32;
...
impl MinMaxComponent for Point3f {
    type Scalar = f32;
...
impl_shr_shl!(Point3i, i8);
impl_shr_shl!(Point3i, i16);
impl_shr_shl!(Point3i, i32);
impl_shr_shl!(Point3i, u8);
impl_shr_shl!(Point3i, u16);
impl_shr_shl!(Point3i, u32);
...
mod tests {
    ...
    fn corner_index_matches_offsets() {
        for c in 0..Point3i::NUM_CORNERS {
            assert_eq!(Point3i::corner_offset(c).as_corner_index(), c);
        }
    }
}
