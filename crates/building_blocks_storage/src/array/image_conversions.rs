...
impl<Im> From<&Im> for Array2x1<<Im as GenericImageView>::Pixel>
where
    Im: GenericImageView,
{
    fn from(image: &Im) -> Self {
        ...
        let mut map: Array2x1<MaybeUninit<<Im as GenericImageView>::Pixel>> =
            unsafe { Array2x1::maybe_uninit(extent) };
