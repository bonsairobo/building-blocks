...
pub trait ChunkStorage<N> {
    ...
    fn get(&self, key: PointN<N>) -> Option<&Self::Chunk>;

    /// Mutably borrow the chunk at `key`.
    fn get_mut(&mut self, key: PointN<N>) -> Option<&mut Self::Chunk>;
